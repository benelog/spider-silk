...
Where Spider Silk sits next to Javalin, Spark, Helidon SE, and Spring Boot, and what it trades away to get there: https://github.com/benelog/spider-silk/blob/main/notes/positioning.md[notes/positioning.md].

Why each piece has the shape it has, item by item, with the rejected list: https://github.com/benelog/spider-silk/blob/main/notes/decisions.md[notes/decisions.md].
