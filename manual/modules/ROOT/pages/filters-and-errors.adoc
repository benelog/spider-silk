...
Both lists are readable back: `app.guards()` reports the filters and the error handlers the way `app.routes()` reports the routes, in xref:route-introspection.adoc#guards[Route Introspection].
