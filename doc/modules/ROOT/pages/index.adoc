...
Where Spider Silk sits next to Javalin, Spark, Helidon SE, and Spring Boot, and what that comparison says should change: https://github.com/benelog/spider-silk/blob/main/docs/positioning.md[docs/positioning.md].
...
What was deliberately deferred, and what would make it worth doing: https://github.com/benelog/spider-silk/blob/main/PLAN.md[PLAN.md].
